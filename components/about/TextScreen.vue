        ...
        >
            <picture class="max-w-[25rem] mx-auto lg:max-w-max">
                <source
                    ...
                    :srcset="
                        config.assetsUri +
                        image.banner.data?.attributes?.formats.large_x2.url
                    "
                />
                <source
                    ...
                    :srcset="
                        config.assetsUri +
                        image.banner.data?.attributes?.formats.medium_x2.url
                    "
                />
                <source
                    ...
                    :srcset="
                        config.assetsUri +
                        image.banner.data?.attributes?.formats.small_x2.url
                    "
                />
                <source
                    ...
                    :srcset="
                        config.assetsUri +
                        image.banner.data?.attributes?.formats.medium.url
                    "
                />
                <source
                    ...
                    :srcset="
                        config.assetsUri +
                        image.banner.data?.attributes?.formats.small.url
                    "
                />
                <img
                    :src="
                        ...
                        image.banner.data?.attributes?.formats.medium_x2.url
                    "
                    :alt="image.banner.data?.attributes?.alternativeText"
                />
            </picture>

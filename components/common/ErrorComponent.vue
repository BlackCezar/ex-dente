...
<template>
    <div class="vertical-padding page-404 bg-accent min-h-screen flex items-center flex-col justify-center">
        <div class="container mx-auto flex flex-col justify-center items-center">
            <div class="lg:mb-12 pt-24 mb-10 status">
                <div class="status-404" v-if="error?.statusCode === 404">
                    ...
                    <span class="block -ml-12 -mr-12 w-[12.625rem] lg:w-[33rem]">
                        <picture class="w-full">
                            <source srcset="~/assets/imgs/tooth.png" media="(max-width: 1024px)" />
                            <img src="~/assets/imgs/tooth-big.png" alt="0" class="w-full" />
                        </picture>
                    </span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="72" height="96" viewBox="0 0 72 96" fill="none"
                        class="h-[6rem] lg:h-[16rem] lg:w-[12rem] w-[4.5rem]">
            ...
            <div class="text-[1.75rem] lg:text-[3rem] text-center lg:mb-12 font-semibold font-serif text-white mb-10">
                {{
            ...
            <div>
                <UiButton @click="$router.push('/')" mode="dark">НА ГЛАВНУЮ</UiButton>
            </div>
        </div>
    </div>
</template>

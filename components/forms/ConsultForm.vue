...
<form @submit.prevent="onProcess">
    <h2 class="text-white lg:leading-[3.625rem] font-semibold mb-3 lg:mb-2 text-[1.75rem] font-[Mignon] lg:text-[3rem]">{{isDone ? 'Вы успешно записались на консультацию' : 'Запишитесь на консультацию'}}</h2>
    ...
    <div class="flex flex-col gap-4 mb-8 lg:mb-12 lg:gap-10 lg:flex-row">
        <UiInput name="username" type="text" placeholder="Ваше имя" />
